...
async function recalcScheduleForTechnician(technicianId, appointmentDate, currentLocation) {
    try {
        ...
        if (!pendingApps.length) {
            console.log("No pending appointments for this technician on that day Old.");
            return [];
        }
        ...
        console.error("Error in recalcScheduleForTechnicianOld:", error);
        throw error;
    }
}
...
async function getTravelTime(origin, destination) {
    ...
    try {
        ...
        console.error("Error in getTravelTimeOld:", error);
    }
    return Infinity;
}
